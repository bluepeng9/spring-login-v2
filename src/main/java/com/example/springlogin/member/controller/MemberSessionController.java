...
public class MemberSessionController {
    ...
    @GetMapping("/")
    public String getHomePage(@SessionAttribute(name = "memberId", required = false) Long memberId, Model model) {
    ...
    @PostMapping("/login")
    public String login(@ModelAttribute("memberLoginRequest") MemberLoginRequest request, Model model, HttpServletRequest servletRequest) {
        log.info("request = {}", request);
